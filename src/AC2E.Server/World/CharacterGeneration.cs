...
namespace AC2E.Server {
    ...
    internal static class CharacterGeneration {
        ...
        public static WorldObject createCharacterObject(WorldObjectManager objectManager, DatReader portalDatReader, string name, SpeciesType species, SexType sex, Dictionary<PhysiqueType, float> physiqueTypeValues) {
            ...
            characterObject.name = new StringInfo(name);
            characterObject.visual = createCharacterVisualComponent(visualDescDid, appProfileMap, physiqueTypeValues);

            return characterObject;
        }

        private static VisualComponent createCharacterVisualComponent(DataId visualDescDid, Dictionary<PhysiqueType, Dictionary<float, Tuple<AppearanceKey, DataId>>> appProfileMap, Dictionary<PhysiqueType, float> physiqueTypeValues) {
