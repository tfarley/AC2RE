...
namespace AC2E.Def {
    ...
    public class DbTypeDef {
        ...
        public static readonly Dictionary<DbType, DbTypeDef> TYPE_TO_DEF = new Dictionary<DbType, DbTypeDef> {
            ...
            { DbType.QUALITIES, new DbTypeDef {
                baseDid = new DataId(0x80000000),
                topDid = new DataId(0x81FFFFFF),
                extension = "",
                packVersion = 1,
                updateType = DbUpdateType.PATCH,
                hasFile = false,
            ...
            { DbType.DATFILEDATA, new DbTypeDef {
                baseDid = new DataId(0xFFFF0000),
                topDid = new DataId(0xFFFFFFFF),
                extension = "",
                packVersion = 1,
                updateType = DbUpdateType.PATCH,
                hasFile = false,
