...
public class FXNode {
    ...
    public enum PackFlag : ulong {
        NONE = 0,
        SOUND_LIST = 1 << 0, // SOUND_LIST 0x00000001
        PARTICLE_LIST = 1 << 1, // PARTICLE_LIST 0x00000002
        CAMERA_ID = 1 << 2, // CAMERA_ID 0x00000004
        APEAR_ID = 1 << 3, // APEAR_ID 0x00000008
        APEAR_KEY = 1 << 4, // APEAR_KEY 0x00000010
        RAMP_TIME = 1 << 5, // RAMP_TIME 0x00000020
        INTENSITY = 1 << 6, // INTENSITY 0x00000040
        HOLDING_LOCATION = 1 << 7, // HOLDING_LOCATION 0x00000080
        BONE_NAME = 1 << 8, // BONE_NAME 0x00000100
        BONE_OFFSET = 1 << 9, // BONE_OFFSET 0x00000200
        HAS_STREAK = 1 << 10, // HAS_STREAK 0x00000400
        START_STREAK = 1 << 11, // START_STREAK 0x00000800
        STOP_STREAK = 1 << 12, // STOP_STREAK 0x00001000
        SLIDER = 1 << 13, // SLIDER 0x00002000
        RESTORE = 1 << 14, // RESTORE 0x00004000
        HAS_COLOR = 1 << 15, // HAS_COLOR 0x00008000
        PROPAGATE_COLOR = 1 << 16, // PROPAGATE_COLOR 0x00010000
        VDESC_ID = 1 << 17, // VDESC_ID 0x00020000
        LIFE_TIME = 1 << 18, // LIFE_TIME 0x00040000
        BEHAVIOR = 1 << 19, // BEHAVIOR 0x00080000
        PARENT = 1 << 20, // PARENT 0x00100000
        UNPARENT = 1 << 21, // UNPARENT 0x00200000
        RETARGET = 1 << 22, // RETARGET 0x00400000
        DESTROY_TARGET = 1 << 23, // DESTROY_TARGET 0x00800000
        TARGET_FX = 1 << 24, // TARGET_FX 0x01000000
        DAY_TIME = 1 << 25, // DAY_TIME 0x02000000
        NIGHT_TIME = 1 << 26, // NIGHT_TIME 0x04000000
        CHANNEL_HASH = 1 << 27, // CHANNEL_HASH 0x08000000
        FIRE_AND_FORGET = 1 << 28, // FIRE_AND_FORGET 0x10000000
        WATER_PLANE = 1 << 29, // WATER_PLANE 0x20000000
        CONDITIONAL_CLONE = 1 << 30, // CONDITIONAL_CLONE 0x40000000
        HAS_DECAL = 1u << 31, // HAS_DECAL 0x80000000
        HAS_LIGHT = 1ul << 32, // HAS_LIGHT 0x0000000100000000
        HAS_REPULSOR = 1ul << 33, // HAS_REPULSOR 0x0000000200000000
        PLAYER_ONLY = 1ul << 34, // PLAYER_ONLY 0x0000000400000000
        HIDE_TARGET = 1ul << 35, // HIDE_TARGET 0x0000000800000000
        FX_SCRIPT = 1ul << 36, // FX_SCRIPT 0x0000001000000000
        COLOR_LIFE_TIME = 1ul << 37, // COLOR_LIFE_TIME 0x0000002000000000
        REMOVE_ROTATION = 1ul << 38, // REMOVE_ROTATION 0x0000004000000000
