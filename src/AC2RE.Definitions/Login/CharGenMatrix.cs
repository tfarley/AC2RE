...
namespace AC2RE.Definitions {
    ...
    public class CharGenMatrix : IPackage {
        ...
        public Dictionary<SpeciesType, Dictionary<uint, IPackage>> startingLocationTable; // m_StartingLocationTable
        ...
        public CharGenMatrix(AC2Reader data) {
            ...
            data.ReadPkg<ARHash>(v => startingLocationTable = v.to<SpeciesType, Dictionary<uint, IPackage>>());
