...
public class Eff_RashanDrudgeBane : Effect {
    ...
    public Eff_RashanDrudgeBane(AC2Reader data) : base(data) {
        data.ReadHO<StringInfo>(v => response10 = v);
        data.ReadHO<StringInfo>(v => response1 = v);
        data.ReadHO<StringInfo>(v => response2 = v);
        data.ReadHO<StringInfo>(v => response3 = v);
        data.ReadHO<StringInfo>(v => response4 = v);
        data.ReadHO<StringInfo>(v => response5 = v);
        data.ReadHO<StringInfo>(v => response6 = v);
        data.ReadHO<StringInfo>(v => response7 = v);
        data.ReadHO<StringInfo>(v => response8 = v);
        data.ReadHO<StringInfo>(v => response9 = v);
    }
}
