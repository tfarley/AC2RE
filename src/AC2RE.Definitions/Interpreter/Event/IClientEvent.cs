    ...
    public interface IClientEvent : IWritable {
        ...
        public static IClientEvent read(ClientEventFunctionId funcId, AC2Reader data) {
            return funcId switch {
                ...
                ClientEventFunctionId.Combat__Combat_AttackError => new AttackErrorCEvt(data),
                ClientEventFunctionId.Combat__Combat_BasicAttacksFailed => new BasicAttacksFailedCEvt(data),
                ...
                ClientEventFunctionId.Inventory__Inventory_ResetContents => new ResetContentsCEvt(data),
