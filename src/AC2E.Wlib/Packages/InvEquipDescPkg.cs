...
namespace AC2E.WLib {
    ...
    public class InvEquipDescPkg : IPackage {
        ...
        public InvEquipDescPkg() {

        }

        public InvEquipDescPkg(BinaryReader data, PackageRegistry registry) {
            m_blockingItemLocation = data.ReadUInt32();
            data.ReadPkgRef<EquipItemProfilePkg>(v => m_eip = v, registry);
